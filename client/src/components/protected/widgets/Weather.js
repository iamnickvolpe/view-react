    ...
    return (
      <div className="weather">
        <div>
          ...
          <div className="section"><span className="normal">Tomorrow </span><span className="bold">{data.forecast.simpleforecast.forecastday[1].high.fahrenheit}&deg;/{data.forecast.simpleforecast.forecastday[1].low.fahrenheit}&deg; {data.forecast.simpleforecast.forecastday[1].conditions}</span></div>
        </div>
      </div>
    );
  }
